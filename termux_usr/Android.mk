...
$(FINAL_TAR_FILE):
	...
	cd $(working)
	/usr/bin/bash $(PRIVATE_SCRIPT) --architectures aarch64 --override apt --add autoconf,automake,bc,bison,clang,cmake,coreutils,curl,ffmpeg,flex,gdb,git,git-lfs,htop,jq,libcurl-static,libffi-static,libjpeg-turbo,libjpeg-turbo-static,liblz4,liblz4-static,liblzo,liblzo-static,libmpc,libtool,libusb,libuuid-static,libzmq,libpcap,libpcap-static,libpng,make,man,nano,ncurses-static,,ndk-sysroot,openssh,openssl,patchelf,perl,python,python-static,rsync,strace,tar,termux-api,tmux,tsu,vim,wget,zlib-static,zsh
